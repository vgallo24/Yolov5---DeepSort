...
##PERSONAL NOTE (Vincenzo Gallo)
MODIFIED cap = cv2.VideoCapture(s,*cv2.CAP_DSHOW*) line 307, yolov5/utils/loggers/datasets.py. WEBCAM COMPATIBILITY
NOW WORKING ON LOGITECH WEBCAM, QUADRO RTX 8000
